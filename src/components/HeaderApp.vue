  ...
  <div>
    <v-container fluid>
      <v-row no-gutters>
        ...
        <v-col>
          <v-navigation-drawer v-model="drawer" absolute fixed temporary>
            <v-list nav dense>
              <v-list-item-group
                v-model="group"
                active-class="amber accent-3 text--accent-4"
              >
                ...
                <v-list-item to="/">
                  <v-list-item-title
                    ><v-icon>mdi-home </v-icon> Inicio</v-list-item-title
                  >
                </v-list-item>
                <v-list-item to="new">
                  <v-list-item-title>
                    <v-icon>mdi-plus-box</v-icon> Nuevo Anuncio
                  </v-list-item-title>
                </v-list-item>

                <v-list-item>
                  <v-list-item-title>
                    <v-icon>mdi-cart-outline</v-icon>Carrito</v-list-item-title
                  >
                </v-list-item>
